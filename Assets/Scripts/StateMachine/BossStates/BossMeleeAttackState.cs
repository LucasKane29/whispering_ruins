...
public class BossMeleeAttackState : BossBaseState
{
    ...
    public BossMeleeAttackState(BossController agent, NavMeshAgent navMeshAgent, Animator animator,
    ...
    public override void OnEnter()
    {
        ...
        animator.CrossFade(BossAnimIDs.MeleeAttack, crossFadeDuration);
    }
    ...
    public override void Update()
    {
        ...
        if (stateInfo.shortNameHash != BossAnimIDs.MeleeAttack) return;
